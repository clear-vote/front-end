...
export default function MyBallotPage({
  ...
  searchParams: { example: boolean | undefined, lat: string | undefined, lng: string | undefined }
}) {

  if(searchParams.example !== undefined){
    //contents of stock example about page
    return (
      ...
      <section className="max-w-[660px] flex flex-col gap-6 items-center">
        ...
        <div className="my-8 flex flex-col gap-2 text-center">
          <p className="text-lg font-600 text-disabled-foreground">Example Upcoming Election</p>

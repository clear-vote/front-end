...
export function CandidateCard(props: CandidateProps) {
 ...
 return (
  ...
  // <Drawer>
  //   <DrawerTrigger>
  //     <div className="flex-none bg-card hover:bg-card-hover elevation-1 border border-1 rounded-lg p-6 flex flex-col gap-0 items-start max-w-[calc(200px+1.5rem)]">
  //       <Image 
  //         src={ props.image_source }
  //         alt="candidate headshot"
  //         height={200}

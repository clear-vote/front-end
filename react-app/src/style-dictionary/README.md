# What is this?
In a design system, people often use special entities called “design tokens” to store their “design decisions”. They typically take the form of key/value pairs. These are very helpful for maintaining consistent styling within a project! This tool gives you a way to set up + manage tokens in a very intuitive way.

For example:
$color-base-gray-light: #cccccc;

style-dictionary uses Sass (.scss).

Please read this excellent blog post for more information:
